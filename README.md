...
✔ Developed AI model & AI automation

What makes me a 𝐒𝐎𝐋𝐈𝐃 𝐄𝐗𝐏𝐄𝐑𝐓? Clients love that I’m reliable, meet deadlines, and can turn complex ideas into simple, effective solutions.

🔧 𝐊𝐄𝐘 𝐒𝐊𝐈𝐋𝐋𝐒 & 𝐓𝐄𝐂𝐇𝐍𝐎𝐋𝐎𝐆𝐈𝐄𝐒

▶ AI model development & AI automation: LLM, CNN, Tensorflow, Pytorch, n8n, make.com.
...
API, RESTful API, API Integration, AWS Lambda, Amazon Web Services, Docker, Git, Agile Software Development, Python, JavaScript, ECMAScript, TypeScript, jQuery, AngularJS, React, Redux, Next.js, ExpressJS, Node.js, Prisma, PostgreSQL, SQL, CSS, CSS3, Sass, Tailwind CSS, HTML, HTML5, Template Markup, Mobile App Development, React Native, iOS, iOS Development, Android, Android App Development, Web Development, Web Application, Website, Web Design, Graphic Design, UI/UX Prototyping, User Authentication, Search Engine Optimization, Social Media Account Integration, Chat & Messaging Software, Twilio API, Expo.io, Landing Page, comfy, polotno, Artificial Intelligence, AI model developmebt, AI automation, LLM, n8n, zapier
